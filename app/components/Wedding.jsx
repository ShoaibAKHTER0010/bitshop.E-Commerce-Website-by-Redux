...
const Wedding = () => {
  return (
    <section className='w-full bg-[#b66087] py-12'>
           ...
           <h2>THE <br /> <span className='inline-flex text-[#60b690]'>WEDDING</span> COLLECTION</h2>
            ...
            <div className='w-full flex flex-col md:flex-row justify-center items-center gap-6 md:gap-14 bg-[#ac7e93] rounded-xl'>
                ...
                <div className='w-full flex justify-center items-center md:w-[30vw] ml-4 py-4'>
                    <div>
                  <img src="./images/wed/wed-3.png" alt="img-1" />
                    </div>
                ...
                {/* second-div */}
                <div className='w-full md:w-[40vw]  mr-6 flex flex-col-reverse md:flex-col md gap-4 justify-center items-center'>
                    {/* button side */}
                <div className='w-full flex flex-col  gap-6 py-[4rem] bg-[#ac7e93] md:bg-[#b66087] rounded-b-xl -mt-0 md:-mt-14 px-10 md:px-4 '>
                      {/* button--1 */}
    ...
    transition-transform duration-300 ease-in-out transform hover:scale-75 '>Explore Now
                   ...
                   {/* image */}
                    <div className='transition-transform duration-300 ease-in-out transform hover:scale-110 hover:translate-y-3 pl-5 md:pl-0'>
                  <img src="./images/wed/wed-2.png" alt="img-2" />
                    </div>

                </div>

                   {/* third-div */}
                   <div className='w-[30vw] py-4 hidden md:flex'>
                    <div>
                  <img src="./images/wed/wed-1.png" alt="img-3" />
                    </div>
