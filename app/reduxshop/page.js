  ...
  return (
    <main className="w-full bg-[#F1DFCA]">
      ...
      <div className="mx-auto max-w-7xl flex flex-col justify-center items-center px-10">
        <h1 className="text-[#4A3D2E] text-[35px] md:text-[45px] font-extrabold font-['Manrope'] leading-[35px] md:leading-[50px] py-16 text-center">
          Our Products
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.length > 0 ? (
            products.map((product) => (
              <div key={product.id} className="bg-white p-8 md:p-6 rounded-lg shadow-lg hover:shadow-2xl transition transform hover:scale-105 flex flex-col border-2 border-slate-400">
                ...
                <button
                  className="text-[#4A3D2E] font-[Poppins] px-4 md:px-6 p-2 mt-8 rounded-full border-black border-2 bg-white hover:bg-[#EFDCC7]
